...
public class Mec_Odo_AutonomousLevel5_Dec14Tourney extends LinearOpMode {
    ...
    public void driveLoadingZone() throws InterruptedException {
        ...
        if(isRedAlliance) {
            ...
            robot.driveOdo.translateDrive(0, 6, .9, 0,  1);
            robot.driveOdo.waitUntilDone();
            robot.jaws.intakeJawsRed();
            switch (skyStonePos) {
                case INSIDE:
                    robot.driveOdo.translateDrive( 3, 28, .65, -38,  2.5);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.5);
                    robot.driveOdo.translateDrive( -7, 46, .7,  -55,  2);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( 7, 24, .8, 70,  3);
                    robot.driveOdo.waitUntilDone();
                    break;
                case CENTER:
                    robot.driveOdo.translateDrive( 11, 28, .8, -38,  2.5);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.55);
                    robot.driveOdo.translateDrive( 4, 44, .8, -55,  2);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( 17, 24, .8, 70,  3);
                    robot.driveOdo.waitUntilDone();
                    break;
                case OUTSIDE:
                    robot.driveOdo.translateDrive( 15, 28, .8, -28,  2.5);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.35);
                    //collect sky stone
                    robot.driveOdo.translateDrive( 11, 44, .56, -55 ,  2.5);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.translateDrive( 13 , 24, .8, 60 ,  3);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
            ...
            robot.driveOdo.translateDrive( 41, 26, .8, 90 ,  2.5);
            robot.driveOdo.waitUntilDone();
            ...
            switch (skyStonePos) {
                case INSIDE:
                    ...
                    robot.driveOdo.translateDrive( -28, 20, .8,  -40,  4);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.55);
                    //collect sky stone
                    robot.jaws.intakeJawsRed();
                    robot.driveOdo.translateDrive( -31 , 47, .8,  -70 ,  2);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( -17 , 18, .8, 70 ,  3);
                    robot.driveOdo.waitUntilDone();
                    break;
                case CENTER:
                    //go to center position
                    robot.driveOdo.translateDrive( -21 , 28, .8, -37 ,  4);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.5);
                    //collect sky stone
                    robot.jaws.intakeJawsRed();
                    robot.driveOdo.translateDrive(-25.5 , 49, .7, -52 ,  2);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( -7 , 22, .8, 70 ,   4);
                    robot.driveOdo.waitUntilDone();
                    break;
                case OUTSIDE:
                    //go to right position
                    robot.driveOdo.translateDrive(  -15 , 28, .8, -20 ,  3);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.35);
                    //collect sky stone
                    robot.jaws.intakeJawsRed();
                    robot.driveOdo.translateDrive(-17 , 47, .56,-55 ,  3);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.translateDrive( -11, 22, .8, 60 ,  4);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    break;
            ...
            if (skyStonePos == CatHW_Vision.skyStonePos.INSIDE) {
                ...
                robot.jaws.turnOffJaws();
                robot.driveOdo.translateDrive(41 , 16.5, .80,96 ,  2.5);
                robot.driveOdo.waitUntilDone();
                //release sky stone while backing up
                robot.jaws.outputJaws();
                //park under sky bridge
                robot.driveOdo.translateDrive(25 , 16.5, .85,96,  2);
                robot.driveOdo.waitUntilDone();

            } else {
                //drive under Sky bridge and deliver sky stone
                robot.jaws.turnOffJaws();
                robot.driveOdo.translateDrive(41 , 21, .85,  96 ,  2.5);
                robot.driveOdo.waitUntilDone();
                //release sky stone while backing up
                robot.jaws.outputJaws();
                //park under sky bridge
                robot.driveOdo.translateDrive(23.5, 20, .85,96,  2);
                robot.driveOdo.waitUntilDone();
            ...
            switch (skyStonePos) {
                case INSIDE:
                    robot.driveOdo.translateDrive( -4, 26, .65,  38,  2.5);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.5);
                    robot.driveOdo.translateDrive( 0, 44, .7, 55,  2);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( -8, 22, .8, -70,  3);
                    robot.driveOdo.waitUntilDone();
                    break;
                case CENTER:
                    robot.driveOdo.translateDrive( -13, 26, .8, 38,  2.5);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.55);
                    robot.driveOdo.translateDrive( -7, 42, .8, 55,  2);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( -19, 22, .8, -70,  3);
                    robot.driveOdo.waitUntilDone();
                    break;
                case OUTSIDE:
                    robot.driveOdo.translateDrive( -17, 26, .8,  20,  2.5);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.35);
                    //collect sky stone
                    robot.driveOdo.translateDrive( -17, 42, .56,  50,  2.5);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.translateDrive( -15, 22, .8, -60,  3);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
            ...
            //drive under Sky bridge
            robot.jaws.turnOffJaws();
            robot.driveOdo.translateDrive( -41, 24, .8, -90,  2.5);
            robot.driveOdo.waitUntilDone();
            //release sky stone while backing up
            robot.jaws.outputJaws();
            ...
            switch (skyStonePos) {
                case INSIDE:
                    //go to center position
                    robot.driveOdo.translateDrive( 26, 18, .8, 40,  4);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.55);
                    //collect sky stone
                    robot.jaws.intakeJawsBlue();
                    robot.driveOdo.translateDrive( 29, 40, .8, 60,  2);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( 14, 16, .8, -70,  3);
                    robot.driveOdo.waitUntilDone();
                    break;
                case CENTER:
                    //go to center position
                    robot.driveOdo.translateDrive( 15, 20, .8, 37,  4);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.5);
                    //collect sky stone
                    robot.jaws.intakeJawsBlue();
                    robot.driveOdo.translateDrive( 20, 40, .7, 52, 2);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    robot.driveOdo.translateDrive( 1, 18, .8, -70,  4);
                    robot.driveOdo.waitUntilDone();
                    break;
                case OUTSIDE:
                    //go to right position
                    robot.driveOdo.translateDrive( 16, 20, .8, 20,  3);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerBoast(.35);
                    //collect sky stone
                    robot.jaws.intakeJawsBlue();
                    robot.driveOdo.translateDrive( 18, 40, .56, 55,  3);
                    robot.driveOdo.waitUntilDone();
                    //back up from stones
                    robot.driveOdo.translateDrive( 11, 18, .8, -60,  4);
                    robot.driveOdo.waitUntilDone();
                    robot.driveOdo.updatesThread.powerUpdate.powerNormal();
                    break;
            ...
            if (skyStonePos == CatHW_Vision.skyStonePos.INSIDE) {
                //drive under Sky bridge and deliver sky stone
                robot.jaws.turnOffJaws();
                robot.driveOdo.translateDrive( -41, 12.5, .80, -96,  2.5);
                robot.driveOdo.waitUntilDone();
                //release sky stone while backing up
                robot.jaws.outputJaws();
                //park under sky bridge
                robot.driveOdo.translateDrive( -25.5, 12.5, .85, -96,  2);
                robot.driveOdo.waitUntilDone();

            } else {
                //drive under Sky bridge and deliver sky stone
                robot.jaws.turnOffJaws();
                robot.driveOdo.translateDrive( -41, 17, .85, -96,  2.5);
                robot.driveOdo.waitUntilDone();
                //release sky stone while backing up
                robot.jaws.outputJaws();
                //park under sky bridge
                robot.driveOdo.translateDrive( -25.5, 17, .85, -96,  2);
                robot.driveOdo.waitUntilDone();
    ...
    public void driveBuildZone() throws InterruptedException {
        ...
        robot.driveOdo.translateDrive( isRedAlliance ? -20 : 17,-35,.45,isRedAlliance ? 8 : -8,4);
        robot.driveOdo.waitUntilDone();
        ...
        robot.driveOdo.translateDrive(isRedAlliance ? -13 : 13,-19,.9,0,3);
        robot.driveOdo.waitUntilDone();
        //rotate the foundation while moving forward
        robot.driveOdo.translateDrive(isRedAlliance ? -5 : 5,-6,.9,isRedAlliance ? 90 : -90,4);
        robot.driveOdo.waitUntilDone();
        //push the foundation against the wall
        robot.driveOdo.translateDrive(isRedAlliance ? -13 : 13,-6,.9,isRedAlliance ? 90 : -90,3);
        robot.driveOdo.waitUntilDone();
        ...
        robot.robotWait(.25);
        if(isParkAtWall){
            robot.driveOdo.translateDrive(isRedAlliance ? -5 : 5, -3, .8, isRedAlliance ? 90 : -90,  2);
            robot.driveOdo.waitUntilDone();
            robot.driveOdo.translateDrive(isRedAlliance ? 25 : -26, isRedAlliance ? -3 : 0, .8, isRedAlliance ? 90 : -90,  2);
            robot.driveOdo.waitUntilDone();
        }
        else {
            robot.driveOdo.translateDrive(isRedAlliance ? -5 : 5, -30, .8, isRedAlliance ? 90 : -90,  2);
            robot.driveOdo.waitUntilDone();
            robot.driveOdo.translateDrive(isRedAlliance ? 22 : -26, isRedAlliance ? -33 : -28, .8, isRedAlliance ? 90 : -90,  2);
            robot.driveOdo.waitUntilDone();
        }
